...
if ($_POST){
    ...
    if (isset($_POST['btnGuardar'])){
        ...
        $rbSexo = (isset($_POST['rbSexo'])) ? $_POST['rbSexo'] : '1';
        
        $txtFechaNacimiento = (isset($_POST['txtFechaNacimiento'])) ? fecha_mysql($_POST['txtFechaNacimiento']) : date('Y-m-d');
        ...
        $txtUbigeo = (isset($_POST['txtUbigeo'])) ? $_POST['txtUbigeo'] : '';
        ...
        $rpta = $objData->Registrar($hdIdPrimary, $IdEmpresa, $IdCentro, $txtnroDNI, $txtNombres, $txtApellidos, $rbSexo, $txtFechaNacimiento, $txtTelefono, $txtCelular, $txtEmail, $txtFacebook, $txtUbigeo, $txtDireccion, $urlFoto, $idusuario, $rpta, $titulomsje, $contenidomsje);
    }
