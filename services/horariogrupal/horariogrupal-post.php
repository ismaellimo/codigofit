...
if ($_POST){
    ...
    if (isset($_POST['btnGuardar'])){
        ...
        $txtRutina = $_POST['txtRutina'];
        $txtInstructor = $_POST['txtInstructor'];
        $txtAmbiente = $_POST['txtAmbiente'];
        $TxtDia = $_POST['ddlDia'];
        $txtHoraInicio = $_POST['txtHoraInicio'];
        $txtHoraFinal = $_POST['txtHoraFinal'];
        $txtAforo = $_POST['txtAforo'];

        $rpta = $objData->Registrar($hdIdPrimary, $IdEmpresa, $IdCentro, $txtRutina, $txtInstructor, $txtAmbiente, $txtDia, $txtHoraInicio, $txtHoraFinal, $txtAforo, $idusuario, $rpta, $titulomsje, $contenidomsje);
    }
