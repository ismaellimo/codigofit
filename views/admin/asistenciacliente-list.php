<form id="form1" name="form1" method="post">
    ...
    <div class="page-region">
        <div id="pnlForm"  class="demo-layout-waterfall mdl-layout mdl-js-layout mdl-layout--fixed-header">
            <header class="mdl-layout__header mdl-layout__header--waterfall">
                <div class="mdl-layout__header-row">
                    <span class="mdl-layout-title">Registro de asistencia</span>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="input-field full-size">
                                    ...
                                    <label class="active" for="ddlServicio"><?php $translate->__('Servicio'); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
        ...
        <div id="pnlListado" class="demo-layout-waterfall mdl-layout mdl-js-layout mdl-layout--fixed-header" style="display: none;">
            <header class="mdl-layout__header mdl-layout__header--waterfall">
                <div class="mdl-layout__header-row">
                    <span class="mdl-layout-title">Lista de asistencia</span>
                </div>
            </header>
