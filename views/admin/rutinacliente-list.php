            ...
            <div class="all-height">
                <div class="row">
                    <div class="input-field full-size">
                        <input class="validate" type="text" id="txtObjetivo" name="txtObjetivo">
                        <label for="txtObjetivo"><?php $translate->__('Objetivo'); ?></label>
                    </div>
                </div>
                <div class="row">
                    ...IdPersonal (Instructor)
                </div>
                <div class="row">
                    <div class="input-field full-size">
                ...
                <div class="row">
                    <div class="input-field full-size">
                        <input class="validate" type="text" id="txtIMC_Actual" name="txtIMC_Actual" value="0">
                        <label for="txtIMC_Actual">IMC Actual</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field full-size">
                        <input class="validate" type="text" id="txtIMC_Meta" name="txtIMC_Meta" value="0">
                        <label for="txtIMC_Meta">IMC Meta</label>
                    </div>
                </div>
            </div>
        </div>
