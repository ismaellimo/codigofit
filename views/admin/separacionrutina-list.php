        ...
        <div id="pnlListado" class="demo-layout-waterfall mdl-layout mdl-js-layout mdl-layout--fixed-header">
            <header class="mdl-layout__header mdl-layout__header--waterfall">
                <div class="mdl-layout__header-row">
                    <span class="mdl-layout-title">Separación rutinas grupales</span>
                    ...
                    <div class="cell colspan6 all-height body-on-phone no-footer mdl-shadow--4dp">
                        <div class="scrollbarra padding20">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="input-field">
                                        <select name="ddlHorarioGrupal" id="ddlHorarioGrupal" class="browser-default">
                                        </select>
                                        <label class="active" for="ddlHorarioGrupal"><?php $translate->__('Horario Grupal'); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="input-field">
                                        <select name="ddlRutinaGrupal" id="ddlRutinaGrupal" class="browser-default">
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="input-field">
                                        <select name="ddlCliente" id="ddlCliente" class="browser-default">
                                        </select>
                                        <label class="active" for="ddlCliente"><?php $translate->__('Socio:'); ?></label>
                                    </div>
                                </div>
                            </div>                            <div class="row">
                                <div class="input-field full-size">
                                    <input class="validate" type="text" id="txtFecha" name="txtFecha">
                                    <label for="txtFecha"><?php $translate->__('Fecha'); ?></label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field full-size">
                                    <input class="validate" type="text" id="txtHora" name="txtHora">
                                    <label for="txtHora"><?php $translate->__('Hora'); ?></label>
                                </div>
                            </div>
                            <div class="row">
                                <p>
                                  <input type="checkbox" class="filled-in" id="chkVino" name="chkVino" checked value="1" />
                                  <label for="chkVino"><?php $translate->__('¿Vino?'); ?></label>
                                </p>
                            </div>
