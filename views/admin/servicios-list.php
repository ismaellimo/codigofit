                        ...
                        <div class="scrollbarra padding20">
                            <div class="row">
                                <div class="input-field full-size">
                                    <input class="validate" type="text" id="txtNombreServicio" name="txtNombreServicio">
                                    <label for="txtNombreServicio"><?php $translate->__('Descripción'); ?></label>
                                </div>
                            </div>
                            <div class="row">
                                <p>
                                  <input type="checkbox" class="filled-in" id="chkMembresia" name="chkMembresia" checked value="1" />
                                  <label for="chkMembresia"><?php $translate->__('¿Es Membresia?'); ?></label>
                                </p>
                            </div>
                            <div class="row">
                                <div class="input-field full-size">
