            ...
            <div class="divContent" class="no-overflow">
                <div class="detalleComercio container-details">
                    <div class="headerPedido">
                        <ul>
                            <li class="colProducto"><a href="#"><h4 class="white-text"><?php $translate->__('Items'); ?></h4></a></li>
            ...
            <div class="divContent" class="no-overflow">
                <div class="detalleComercio container-details">
                    <div class="headerPedido">
                        <ul>
                            <li class="colProducto"><a href="#"><h4 class="white-text"><?php $translate->__('Items'); ?></h4></a></li>
                            <li class="colPrecio"><a href="#"><h4 class="white-text">UM</h4></a></li>
                            <li class="colCantidad"><a href="#"><h4 class="white-text"><?php $translate->__('Cantidad'); ?></h4></a></li>
                        </ul>
                    </div>
                    <div class="contentPedido">
                ...
                success: function (data) {
                    ...
                    if (count > 0) {
                        while(i < count){
                            ...
                            strhtml += '<h3 class=" margin10 white-text text-right">' + data[i].td_stock + '</h3>';
                            strhtml += '</div>';
                            strhtml += '</div>';
                            ++i;
                        }
