        ...
        <div class="modal-example-header no-padding mdl-layout--fixed-header">
            <header class="mdl-layout__header">
                <div class="mdl-layout__header-row">
                    <span class="mdl-layout-title">Rutina Grupal</span>
                </div>
            </header>
                    ...
                    <div class="cell colspan6 all-height body-on-phone no-footer mdl-shadow--4dp">
                        ...
                        <div class="row">
                            <div class="input-field full-size">
                                ...
                                <label for="txtNombreRutina"><?php $translate->__('Descripción'); ?></label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field full-size">
                                <input class="validate" type="text" id="txtNombreRutina" name="txtMinutos">
                                <label for="txtMinutos"><?php $translate->__('Minutos separación rutina'); ?></label>
                            </div>
                         </div>
                        </div>
                    </div>
